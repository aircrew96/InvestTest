...
public enum Colors {
  public static let baseBackground = ColorAsset(name: "base_background")
  public static let bg = ColorAsset(name: "bg")
  ...
  public static let text003 = ColorAsset(name: "text_003")
